    ...
    <div className="sidebar static">
      ...
      <div className="widget mt-3">
        <div className="d-flex justify-content-between align-items-center my-2 position-relative">
          ...
          {!suggestion.loading && (
            <i
              className="fas fa-redo position-absolute"
        ...
        <div
          style={{opacity: 0.5, flexDirection: 'column'}}
          className="my-2 d-flex justify-content-between aligns-item-center">
          <a
            href="https://www.github.com/vinhngo1907"
            target="_blank"
            rel="noreferrer"
          ...
          <small>&copy; 2025 V-NETWORK FROM KOOKUU V.N VIET NAM</small>
        </div>
      </div>
    </div>
  );
